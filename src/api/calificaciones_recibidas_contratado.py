...
# Crear Blueprint para la funcionalidad de calificaciones recibidas por contratado
calificaciones_contratado_bp = Blueprint('calificaciones_contratado_bp', __name__)

@calificaciones_contratado_bp.route('/calificaciones_recibidas/contratado', methods=['GET'])
