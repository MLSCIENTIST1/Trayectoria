...
# Crear Blueprint para rechazar notificaciones
reject_notification_bp = Blueprint('reject_notification_bp', __name__)

@reject_notification_bp.route('/notification/<int:notification_id>/reject', methods=['POST'])
@login_required
def reject_notification_api(notification_id):
    """
