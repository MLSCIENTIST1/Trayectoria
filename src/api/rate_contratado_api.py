...
# Crear Blueprint para la funcionalidad de calificar contratado
rate_contratado_bp = Blueprint('rate_contratado_bp', __name__)

@rate_contratado_bp.route('/rate_contratado/<int:servicio_id>', methods=['POST'])
