...
from src.api.create_service_from_notification_api import create_service_from_notification
...
# Crear Blueprint para aceptar notificaciones
accept_notification_bp = Blueprint('accept_notification_bp', __name__)

@accept_notification_bp.route('/notification/<int:notification_id>/accept', methods=['POST'])
@login_required
def accept_notification_api(notification_id):
    """
