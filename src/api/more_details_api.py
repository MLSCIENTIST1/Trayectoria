...
# Crear Blueprint para solicitar más detalles
more_details_bp = Blueprint('more_details_bp', __name__)

@more_details_bp.route('/detail/notification/<int:notification_id>/detail', methods=['POST'])
@login_required
def more_details_api(notification_id):
    """
