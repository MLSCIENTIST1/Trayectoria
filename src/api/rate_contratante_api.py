...
# Crear Blueprint para la funcionalidad de calificar contratante
rate_contratante_bp = Blueprint('rate_contratante_bp', __name__)

@rate_contratante_bp.route('/rate_contratante/<int:servicio_id>', methods=['POST'])
