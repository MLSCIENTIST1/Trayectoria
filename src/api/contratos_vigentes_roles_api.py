...
# Crear Blueprint para la funcionalidad de contratos vigentes con roles
contratos_vigentes_roles_bp = Blueprint('contratos_vigentes_roles_bp', __name__)

@contratos_vigentes_roles_bp.route('/contratos_vigentes_roles', methods=['GET'])
@login_required
